...
object DevAi2x_PlatformCLinux : BuildType({
    templates(DevAi2x_RunTestSuitesJava, DevAi2x_C)
    name = "Platform C++ (Linux)*"
    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                autoreconf
                ./configure --enable-odbc --enable-tests --prefix=%env.CPP_STAGING% CPPFLAGS=-I%env.CPP_STAGING%/include LDFLAGS=-L%env.CPP_STAGING%/lib
                make -j4 || exit 1
                make install || exit 1
            """.trimIndent()
        }
        script {
            ...
            scriptContent = """
                ...
                automake --add-missing --copy
                autoreconf
                ./configure --prefix=%env.CPP_STAGING% CPPFLAGS=-I%env.CPP_STAGING%/include LDFLAGS=-L%env.CPP_STAGING%/lib
                make -j4 || exit 1
                make install || exit 1
            """.trimIndent()
        }
