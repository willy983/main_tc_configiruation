...
object DevAi2x_MvccCache6 : BuildType({
    templates(DevAi2x_RunTestSuitesJava)
    name = "MVCC Cache 6"

    params {
        text("MAVEN_MODULES", ":ignite-core", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        text("XMX", "12g", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        param("system.IGNITE_FORCE_MVCC_MODE_IN_TESTS", "true")
        text("TEST_SUITE", "IgniteCacheMvccTestSuite6", display = ParameterDisplay.HIDDEN, allowEmpty = true)
    }
