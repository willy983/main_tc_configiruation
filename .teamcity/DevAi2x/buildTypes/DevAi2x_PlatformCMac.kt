...
object DevAi2x_PlatformCMac : BuildType({
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ...
                ./ignite-tests || echo "Process exited with error"
            """.trimIndent()
        }
        script {
            name = "Run ODBC tests (Mac)"
            id = "RUNNER_24"
            executionMode = BuildStep.ExecutionMode.RUN_ON_FAILURE
            ...
            scriptContent = """
                ...
                ./ignite-odbc-tests || echo "Process exited with error"
            """.trimIndent()
        }
        script {
            name = "Run Thin Client tests (Mac)"
            id = "RUNNER_193"
            executionMode = BuildStep.ExecutionMode.RUN_ON_FAILURE
            workingDir = "modules/platforms/cpp"
            scriptContent = """
    ...
    requirements {
        equals("teamcity.agent.jvm.os.name", "Mac OS X", "RQ_10")
    }
