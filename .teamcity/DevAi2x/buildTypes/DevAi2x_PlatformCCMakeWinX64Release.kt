...
object DevAi2x_PlatformCCMakeWinX64Release : BuildType({
    templates(DevAi2x_RunTestSuitesJava, DevAi2x_C)
    name = "Platform C++ CMake (Win x64 | Release)"
    ...
    steps {
        ...
        stepsOrder = arrayListOf("RUNNER_264", "RUNNER_287", "RUNNER_225", "RUNNER_265", "RUNNER_36", "RUNNER_83", "RUNNER_73", "RUNNER_62", "RUNNER_64", "RUNNER_65", "RUNNER_151", "RUNNER_152", "RUNNER_194", "RUNNER_57", "RUNNER_38", "RUNNER_40", "RUNNER_41", "RUNNER_42", "RUNNER_44", "RUNNER_266")
    }
