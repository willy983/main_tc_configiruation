...
object IgniteThinClients_Tests_ThinClientPythonAllPythons : BuildType({
    ...
    name = "Thin client: Python <All-Pythons>"
    ...
    params {
        ...
        param("env.TOX_ENV", "py39")
        param("env.PYENV_PYTHON_VER", "3.9.6")
