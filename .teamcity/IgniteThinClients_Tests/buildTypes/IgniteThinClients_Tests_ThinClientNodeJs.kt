...
object IgniteThinClients_Tests_ThinClientNodeJs : BuildType({
    templates(_Self.buildTypes.Tests_IgniteThinClients_PreBuild, _Self.buildTypes.RunNodeJsTests, _Self.buildTypes.Tests_IgniteThinClients_PostBuild)
    ...
    steps {
        ...
        stepsOrder = arrayListOf("RUNNER_264", "RUNNER_287", "RUNNER_84", "RUNNER_144", "RUNNER_145", "RUNNER_146", "RUNNER_147", "RUNNER_266")
    }
