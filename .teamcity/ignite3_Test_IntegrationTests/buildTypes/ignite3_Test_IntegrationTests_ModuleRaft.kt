...
object ignite3_Test_IntegrationTests_ModuleRaft : BuildType({
    ...
    params {
        text("MODULE", ":ignite-raft", display = ParameterDisplay.HIDDEN, allowEmpty = true)
    }
